package com.meng.zunRunner.ecl.helper;
...
public class EclBulletShooter implements Cloneable {
    ...
    public void shoot() {     
    	if(isLaser){ 
    	//	System.out.println("laser:laser"+laser+" center:"+center+" clength:"+laserCreateLenght+" flength:"+laserFinalLength+" dir:"+directionAngle+" speed:"+speed+" jmp:"+taskToJump);
        ...
        //	System.out.println("way:"+way);
            switch (style) {
                case 0:
                    ...
                    break;
                case 1:
                    directionAngle = MyPlaneReimu.instance.objectCenter.cpy().sub(center).angleRad();
                    createBullets01();
                    break;
                case 2:
                    directionAngle = MyPlaneReimu.instance.objectCenter.cpy().sub(center).angleRad();
