...
import com.meng.zunRunner.anm.ecl.EclFile;
import com.meng.zunRunner.anm.ecl.beans.EclSub;
import com.meng.zunRunner.anm.ecl.beans.EclSubPack;
...
public class AnmManager {
    ...
    public AnmManager(String baseFileName) {
